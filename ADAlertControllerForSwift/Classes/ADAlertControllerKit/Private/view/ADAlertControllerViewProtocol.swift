...
public typealias ADAlertPriority = UInt

/// 最低层级
public let ADAlertPriorityLow: ADAlertPriority = ADAlertPriority.min
/// 默认层级
public let ADAlertPriorityDefault: ADAlertPriority = 100
///中间层级
public let ADAlertPriorityHight: ADAlertPriority = (ADAlertPriority.max - ADAlertPriority.min) / 2
/// 最高层级
public let ADAlertPriorityRequire: ADAlertPriority = ADAlertPriority.max

public protocol ADAlertControllerBaseProtocol {
    func show()
    func hiden()
}

// AlertController 实现优先级队列须遵循的协议,继承自ADAlertControllerBaseProtocol
public protocol ADAlertControllerPriorityQueueProtocol: ADAlertControllerBaseProtocol {
